...
#### 2.阿里云平台部署
在阿里云 [物联网平台](https://iot.console.aliyun.com) 创建产品或者在阿里云 [生活物联网平台](https://living.aliyun.com/#/) 创建产品，会显示在 `物联网平台`，参考[创建产品文档](https://living.aliyun.com/doc#readygo.html). 获取到四元组信息，无需烧录四元组。
